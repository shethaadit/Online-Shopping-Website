<%@ Page Language="C#" MasterPageFile="~/CLIENT/clientmaster2.master" AutoEventWireup="true" CodeFile="login.aspx.cs" Inherits="CLIENT_login"  %>
			...
			<td valign="top">
				<table width="100%" style="height:70%" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td align="left"><asp:TextBox ID="txtUserId" maxlength="24" Width="95%" runat="server"></asp:TextBox></td>
					</tr>
					<tr>
						<td class="hp" style="width:30%;" align="left">Password</td>
						<td align="left"><asp:TextBox ID="txtPassword" TextMode="password" maxlength="24" Width="95%" runat="server"></asp:TextBox></td>
					</tr>
					<tr><td colspan="2">&nbsp;</td></tr>
					<tr>
						<td colspan="2" align="center"><asp:Button ID="btnSignIn" Text="Sign In" runat="server" OnClick="btnSignIn_Click"/></td>
					</tr>
					<tr><td>&nbsp;</td></tr>
				</table>
			</td>
		...
		<tr>
			<td valign="bottom">
				<table width="100%" style="height:30%" cellpadding="0" cellspacing="0">
					...
					<tr><td>&nbsp;</td></tr>
						<tr>
						<td align="center"><asp:Button ID="btnSignUp" Text="Sign Up Now!" runat="server" PostBackUrl="~/CLIENT/userregister.aspx"/></td>
					</tr>
					<tr><td>&nbsp;</td></tr>
				</table>
			</td>

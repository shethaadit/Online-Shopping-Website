...
public partial class CLIENT_UserControl_homelogin : System.Web.UI.UserControl
{
    SqlConnection scon;
    ...
    protected void btnSignIn_Click(object sender, EventArgs e)
    {
        ...
        {
            plhhomelogin.Controls.Add(new LiteralControl("<tr><td colspan='2' style='color:#DD0000;font-size:smaller'>Invalid UserName or Password!</td></tr>"));
		}
    }
}

<%@ Page Language="C#" MasterPageFile="~/ADMIN/adminmaster.master" AutoEventWireup="true" CodeFile="addsubcategory.aspx.cs" Inherits="addsubcategory" Title="Online Shopping Mall" %>
        ...
        <td style="width:50%; height: 100%;border-right: #2aa4d2 1px solid;">
            <table style="height:100%;" cellspacing="0" cellpadding="0" class="add">
                ...
                <tr>
                    ...
                    <td style="width: 50%"><asp:TextBox ID="txtSubCategoryNo" Columns="30" runat="server"></asp:TextBox></td>
                    <td>
                        <asp:RequiredFieldValidator ID="rfvSubCategoryNo" Text="*" runat="server" ErrorMessage="Enter Sub-Category No" ControlToValidate="txtSubCategoryNo" Display="Dynamic" SetFocusOnError="True" Font-Bold="True" Font-Size="Large" ForeColor="Maroon"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3">
                        <center>
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
                          <asp:Button ID="btnCancel" Text="Cancel" Width="30%" runat="server" CausesValidation="false" PostBackUrl="~/ADMIN/add.aspx" />
                        </center>
                    </td>
                </tr>
            </table>

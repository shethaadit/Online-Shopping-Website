<%@ Page Language="C#" MasterPageFile="~/ADMIN/adminmaster.master" AutoEventWireup="true" CodeFile="editproduct.aspx.cs" Inherits="editproduct"  %>
        ...
        <td style="width:50%; height: 100%;border-right: black 1px solid;">
            <table style="height:100%;" cellspacing="0" cellpadding="0" class="add">
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtProductNo" Enabled="false" Width="95%" runat="server"></asp:TextBox></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3">
                        <center>
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="btnCancel" Text="Cancel" Width="30%" CausesValidation="false" runat="server" PostBackUrl="~/ADMIN/viewproduct.aspx" />
                        </center>
                    </td>   
                </tr>
            </table>
